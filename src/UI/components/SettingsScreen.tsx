...
export const SettingsScreen: React.FC<Props> = ({ onExport, onImport, onResetData }) => {
  ...
  const { preferences } = useApplicationServices();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <Select
          value={currentLang}
          onChange={(event) => preferences.setLanguage(event.target.value as 'es' | 'en')}
      ...
      <div className="space-y-3">
        ...
        <Select
          ...
          onChange={(event) => preferences.setDefaultScreen(event.target.value as ScreenType)}
