export const translations = {
  es: {
    ...
    labels: {
      ...
      orderDesc: 'Desc',
      weightShort: 'Peso',
      exportDesc: 'Descarga una copia de seguridad de tus datos',
      importDesc: 'Restaura tus datos desde una copia de seguridad',
      importSuccess: 'Datos importados correctamente',
      importError: 'Error al leer el archivo',
      importRoutineSuccess: 'Rutina importada correctamente',
      importRoutineError: 'Error al importar la rutina',
      ...
      recentProgress: 'Tus cambios recientes',
      recentRegressions: 'Bajadas de rendimiento',
      topWeightExercises: 'Top por peso',
      latestInsight: 'Último cambio',
      insightDetail: 'Análisis detallado',
      weightTrend: 'Evolución de peso',
      repsTrend: 'Evolución de repeticiones',
      ...
      onboardingTagline: 'Entrena con propósito. Sigue tu progreso.',
      ...
      regressionRecord: '¡Bajada de rendimiento!',
      ...
      account: 'Cuenta',
      signInDesc: 'Inicia sesión para sincronizar tus datos entre dispositivos',
      signInToSync: 'Sincroniza tus datos',
      ...
      freeWorkoutDesc: 'Improvisa ejercicios sobre la marcha',
      ...
      workoutSummary: 'Resumen del entreno',
      duration: 'Duración',
      setsCount: 'series',
      restSkip: 'Saltar descanso',
      noWorkouts: 'Sin entrenos todavía',
      noWorkoutsDesc: 'Termina tu primer entreno para verlo aquí',
      chooseDay: 'Elige el día',
      confirmFinish: 'Guardar entreno',
      workoutSaved: 'Entreno guardado',
      discardWorkout: 'Descartar entreno',
      discardWorkoutConfirm: '¿Descartar el entreno en curso? Se perderán las series registradas.',
      leaveWorkout: 'Guardar y salir',
      resumeWorkout: 'Reanudar entreno',
  ...
  en: {
    ...
    labels: {
      ...
      importDesc: 'Restore your data from a backup',
      importSuccess: 'Data imported successfully',
      importError: 'Error reading file',
      importRoutineSuccess: 'Routine imported successfully',
      importRoutineError: 'Error importing routine',
      noLogs: 'No logs',
      ...
      recentProgress: 'Your recent changes',
      recentRegressions: 'Performance drops',
      topWeightExercises: 'Top weight',
      latestInsight: 'Latest change',
      insightDetail: 'Detailed analysis',
      ...
      onboardingTagline: 'Train with purpose. Track your progress.',
      ...
      regressionRecord: 'Performance drop!',
      firstLog: 'First log!',
      loggedToday: 'Logged',
      ...
      freeWorkoutDesc: 'Improvise exercises on the go',
      ...
      noWorkoutsDesc: 'Finish your first workout to see it here',
      chooseDay: 'Choose the day',
      confirmFinish: 'Save workout',
      workoutSaved: 'Workout saved',
      discardWorkout: 'Discard workout',
      discardWorkoutConfirm: 'Discard the active workout? Recorded sets will be lost.',
      leaveWorkout: 'Save and exit',
