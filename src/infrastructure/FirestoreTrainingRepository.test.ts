...
import { createFirestoreTrainingRepository } from './FirestoreTrainingRepository';
import type { TrainingRepository, TrainingSnapshot, SyncStatus } from '../domain/TrainingRepository';
import { Exercise, Routine, Workout } from '../domain';
...
describe('createFirestoreTrainingRepository', () => {
  let dataStore: TrainingRepository;
  ...
  beforeEach(async () => {
    ...
    const { createFirestoreTrainingRepository: factory } = await import('./FirestoreTrainingRepository');
    dataStore = factory({} as never, 'test-user');
  });

  it('emits snapshots after subscribing', async () => {
    const captured: TrainingSnapshot[] = [];
  ...
  it('saves and deletes a routine', async () => {
    ...
    const afterDelete: TrainingSnapshot[] = [];
