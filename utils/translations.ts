...
export const translations = {
  es: {
    ...
    labels: {
      ...
      orderDesc: 'Desc',
      weightShort: 'Peso',
      exportDesc: 'Guarda tus datos en un archivo JSON',
      importDesc: 'Carga tus datos desde un archivo JSON',
  ...
  en: {
    ...
    labels: {
      ...
      orderDesc: 'Desc',
      weightShort: 'Weight',
      exportDesc: 'Save your data to a JSON file',
      importDesc: 'Load your data from a JSON file',
